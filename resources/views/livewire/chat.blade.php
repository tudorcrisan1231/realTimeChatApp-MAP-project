                                ...
                                @else
                                    <li class="flex gap-x-2 sm:gap-x-4">
                                        ...
                                        <div class="group/chat bg-white border border-gray-200 rounded-lg p-2 sm:px-4 space-y-3 text-xs sm:text-sm relative">
                                            ...
                                            <div wire:click="sendReport({{$chat->sender_id}}, {{$chat->id}})" class="hidden absolute -top-2 -right-2 group-hover/chat:flex items-center justify-center rounded-full bg-gray-200 cursor-pointer" title="Report this message">
