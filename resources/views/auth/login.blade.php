...
<section class="bg-white h-screen">
    <div class="grid grid-cols-1 lg:grid-cols-2 h-full">
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            <div class="flex items-center justify-between">
                                ...
                                {{-- <a href="#" title="" class="text-sm font-medium text-amber-600 hover:underline hover:text-amber-700 focus:text-amber-700"> Forgot password? </a> --}}
                            </div>
                            <div class="mt-2.5">
                                <input
                                    type="password"
                        ...
                        <div>
                            <button type="submit" class="inline-flex items-center justify-center w-full px-4 py-4 text-base font-semibold text-white transition-all duration-200 bg-amber-600 border border-transparent rounded-md focus:outline-none hover:bg-amber-700 focus:bg-amber-700">Log in</button>
                        </div>
                    </div>
                </form>
        ...
        <div class="flex items-center justify-center px-4 py-10 sm:py-16 lg:py-24 bg-gray-50 sm:px-6 lg:px-8">
            <div>
                <img class="w-full mx-auto" src="{{asset('src/login.svg')}}" alt="" />
